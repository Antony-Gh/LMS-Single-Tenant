...
import 'package:esoi/app/models/support_model.dart';
...
class SupportService {
  ...
  static Future<bool> createMessage(String title, String desc,
      int? departmentId, int? courseId, File? file) async {
    try {
      ...
      dio.FormData formData = dio.FormData.fromMap({
        ...
        if (file != null) ...{
          "attach": await dio.MultipartFile.fromFile(file.path,
