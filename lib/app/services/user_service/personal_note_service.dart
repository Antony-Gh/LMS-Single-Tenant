...
class PersonalNoteService {
  static Future<bool> create(
      int courseId, int itemId, String desc, File? file, String type) async {
    try {
  ...
  static Future<NoteModel?> getNote(int id, String type) async {
    try {
      String url =
          '${Constants.baseUrl}panel/webinars/personal-notes?item=$id&type=$type';
  ...
  static Future<bool> delete(int id) async {
    try {
      String url =
          '${Constants.baseUrl}panel/webinars/personal-notes/delete/$id';
