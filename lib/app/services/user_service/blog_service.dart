...
import 'package:esoi/app/models/basic_model.dart';
...
class BlogService {
  ...
  static Future<bool> saveComments(
      int postId, int? commentId, String itemName, String comment) async {
    try {
  ...
  static Future<bool> reportComments(int commentId, String message) async {
    try {
      ...
      Response res = await httpPostWithToken(url, {"message": message});
