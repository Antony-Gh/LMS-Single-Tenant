...
class QuizWidget {
        ...
        Container(
          ...
          child: SliderTheme(
            ...
            child: Slider(
              ...
              min: 1,
              max:
                  double.parse(quizData?.questions?.length.toString() ?? '2.0'),
  ...
  static Widget multiAnswerItem(Answer answer, bool isReview,
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: style10Regular()
                          .copyWith(color: whiteFF_26, height: 1),
                    ),
                  ))
            }
          ],
