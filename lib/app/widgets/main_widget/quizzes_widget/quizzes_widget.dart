...
import 'package:esoi/app/models/list_quiz_model.dart';
...
class QuizzesWidget {
  static Widget item(Quiz data, Function onTap,
      {bool isMyResult = true,
      String? userGrade,
      String? status,
      bool isShowQuestionCount = false,
      bool isShowStatus = true,
      bool isShowQuizTime = false}) {
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  shape: BoxShape.circle, color: greyB2),
