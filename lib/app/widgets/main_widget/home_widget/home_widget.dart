...
import 'package:esoi/app/pages/main_page/home_page/notification_page.dart';
import 'package:esoi/app/pages/main_page/home_page/search_page/suggested_search_page.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          input(nameController, nameNode, appText.yourName,
                              ...
                              leftIconSize: 14,
                              isBorder: true),
                          if (PublicData.apiConfigData?['referralSettings']
                                  ['status'] ??
                              false) ...{
                            space(16),
                            input(referralController, referralNode,
                                appText.refCode,
