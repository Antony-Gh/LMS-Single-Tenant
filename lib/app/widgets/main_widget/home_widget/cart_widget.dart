...
import 'package:esoi/app/models/banks_model.dart';
import 'package:esoi/app/pages/main_page/home_page/cart_page/bank_accounts_page.dart';
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              space(18),
              input(couponController, couponNode, appText.enterACouponCode,
                  isBorder: true, iconPathLeft: AppAssets.ticketSvg),
              space(18),
              Center(
                child: button(
                    onTap: () async {
                      if (couponController.text.trim().isNotEmpty) {
                        ...
                        var res = await CartService.validateCoupon(
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              space(18),
              input(amountController, amountNode, appText.amount,
                  isBorder: true,
              ...
              space(16),
              input(referenceController, referenceNode, appText.reference,
              ...
              input(
                ...
                (date == null)
                    ? appText.date
                    : timeStampToDateHour(date!.millisecondsSinceEpoch,
                        isUtc: false),
                isBorder: true,
