...
import 'package:esoi/app/pages/main_page/home_page/certificates_page/certificates_page.dart';
import 'package:esoi/app/pages/main_page/home_page/single_course_page/single_content_page/single_content_page.dart';
...
import 'package:esoi/app/services/user_service/personal_note_service.dart';
import 'package:esoi/app/services/user_service/rewards_service.dart';
...
class SingleCourseWidget {
                          ...
                          return horizontalChapterItem(
                            ...
                            () {
                              if ((contents[index].items?[i].can?.view ??
                                      false) ||
                                  (contents[index].items?[i].accessibility ==
                                      'free')) {
  ...
  static Widget courseOption(
    ...
    return Container(
      ...
      width: 200,
      decoration: BoxDecoration(
          color: whiteFF_26, borderRadius: borderRadius(radius: 15)),
      child: Row(
        children: [
          Container(
            width: 46,
  ...
  static showAddNoteDialog(int courseId, int itemId, String type,
      {String? text}) async {
