        ...
        children: [
              ...
              if (data.sender != null) ...{
                Container(
                  ...
                  decoration: BoxDecoration(shape: BoxShape.circle, boxShadow: [
                    boxShadow(Colors.black.withOpacity(.11), blur: 15, y: 10)
                  ]),
                  child: ClipRRect(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadiusDirectional.only(
                          ...
                          bottomEnd:
                              Radius.circular(data.sender == null ? 0 : 20),
                          bottomStart:
                              Radius.circular(data.sender == null ? 20 : 0))),
                  child: Text(
                    data.message ?? '',
          ...
          Padding(
            padding: EdgeInsetsDirectional.only(
                start: data.sender == null ? 0 : 60, top: 8),
            child: Text(
          ...
          if (data.filePath != null) ...{
            Container(
              margin: EdgeInsetsDirectional.only(
                  top: 12, start: data.sender == null ? 0 : 60),
              width: getSize().width,
              alignment: data.sender == null
                  ? AlignmentDirectional.centerEnd
                  : AlignmentDirectional.centerStart,
          ...
          child: StatefulBuilder(builder: (context, state) {
            return Column(
              ...
              children: [
                ...
                space(20),
                input(titleController, titleNode, appText.grade,
                    isBorder: true,
