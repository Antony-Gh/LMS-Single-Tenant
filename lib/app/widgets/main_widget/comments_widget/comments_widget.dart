...
import 'package:esoi/app/services/user_service/comments_service.dart';
import 'package:esoi/common/badges.dart';
...
class CommentsWidget {
  static Widget myCommnetsItem(Comments data, Function onTap,
        ...
        child: Row(
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: Stack(
                children: [
                  fadeInImage(data.webinar?.image ?? '', 135, height),
                ...
                child: button(
                    onTap: () async {
                      if (messageController.text.trim().isNotEmpty) {
                        ...
                        bool res = await CommentsService.instructorReplay(
                            id, messageController.text.trim());
                ...
                child: button(
                    onTap: () async {
                      if (messageController.text.trim().isNotEmpty) {
                        ...
                        bool res = await CommentsService.report(
                            id, messageController.text.trim());
                ...
                child: button(
                    onTap: () async {
                      if (messageController.text.trim().isNotEmpty) {
                        ...
                        bool res = await CommentsService.update(
                            id, messageController.text.trim());
