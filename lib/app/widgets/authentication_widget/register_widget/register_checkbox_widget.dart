...
class RegisterCheckboxWidget extends StatefulWidget {
  ...
  const RegisterCheckboxWidget(this.setData, this.title, this.options,
      {super.key});
      ...
      children: [
        ...
        ...List.generate(widget.options.length, (index) {
          return Padding(
            ...
            child: checkButton(widget.options[index].getTitle(),
                ids.contains(widget.options[index].id), (value) {
