...
import 'package:esoi/app/pages/main_page/categories_page/categories_page.dart';
            ...
            child: Wrap(
              ...
              children: [
                SingleCourseWidget.courseStatus(
                  appText.students,
                  course?.salesCountNumber?.toString() ??
                    ...
                    children: [
                      Expanded(
                        child: horizontalChapterItem(
                          ...
                          setState(() {});
                        }, transparentColor: true, isFixWidth: true),
                      ),
                      space(0, width: 12),
                      SvgPicture.asset(
                            ...
                            children: [
                              ...List.generate(
                                ...
                                return horizontalChapterItem(
                                    ...
                                    () async {
                                  nextRoute(OfflineSingleContentPage.pageName,
                                      arguments: [
                                        courseId,
