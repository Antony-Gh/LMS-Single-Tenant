...
//   final apiToken = '6c909f616809df32c5c661b3b64fb7e8f0afad4e6c16524c73';
  ...
  final apiToken = 'f6aea6ae383a95b5e366117d26492ead9eb22cf2a04e707fc2';
  ...
  void fetchPaymentMethods() async {
    ...
    try {
      final response =
          await http.get(Uri.parse(getPaymentMethodsUrl), headers: headers);
      final responseData = json.decode(response.body);
                      ...
                      children: [
                        ...
                        if (successPaymentData!['meezaReference'] != null) ...[
                          ...
                          if (successPaymentData!['meezaQrCode'] != null) ...[
                            ...
                            QrImageView(
                              data:
                                  successPaymentData!['meezaQrCode'].toString(),
