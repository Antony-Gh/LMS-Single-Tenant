...
import 'package:esoi/app/widgets/main_widget/blog_widget/blog_widget.dart';
                      ...
                      children: [
                        ...
                        Hero(
                          ...
                          child: ClipRRect(
                              ...
                              child: fadeInImage(
                                  blogData!.image ?? '', getSize().width, 210)),
                        ),
                        ...
                        if (blogData!.comments?.isEmpty ?? true) ...{
                          ...
                          ...List.generate(blogData!.comments?.length ?? 0,
                            ...
                            return commentUi(blogData!.comments![index], () {
                              BlogWidget.showOptionDialog(blogData!.id!,
                                  blogData!.comments![index].id!, userIsLogin);
                            });
                          }),
                        },
