...
import 'package:esoi/app/pages/main_page/home_page/assignments_page/submissions_page.dart';
import 'package:esoi/app/services/user_service/assignment_service.dart';
...
class _AssignmentOverviewPageState extends State<AssignmentOverviewPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      isMyAssignment =
          (ModalRoute.of(context)!.settings.arguments as List)[1] ?? true;
                            ...
                            children: [
                              if (isMyAssignment) ...{
                                ...
                                SingleCourseWidget.courseStatus(
                                  ...
                                  (assignment?.deadline?.toString() ?? '')
                                          .isNumeric()
                                      ? '${assignment?.deadline?.toString() ?? ''} ${appText.day}'
                                      : assignment?.deadline?.toString() ?? '',
                              ...
                              if (isMyAssignment) ...{
                                ...
                                SingleCourseWidget.courseStatus(
                                  ...
                                  timeStampToDateHour(
                                      (assignment?.lastSubmission ?? 0) * 1000),
                                  AppAssets.calendarSvg,
                                  width: (getSize().width * .5) - 42,
                                ),
                              } else ...{
                              ...
                              SingleCourseWidget.courseStatus(
                                ...
                                isMyAssignment
                                    ...
                                    : assignment?.avgGrade?.toString() ?? '0',
                                AppAssets.chartSvg,
                                width: (getSize().width * .5) - 42,
                              ),
                              SingleCourseWidget.courseStatus(
                                ...
                                appText.status,
                                isMyAssignment
                                    ? assignment?.userStatus?.toString() ?? '-'
                                ...
                                ...List.generate(students.length, (index) {
                                  return Padding(
                                    ...
                                    child: userProfile(
                                      ...
                                      isBoldTitle: true,
                                      isBackground: true,
                                      customSubtitle: timeStampToDate(
                                          (students[index].purchaseDate ?? 0) *
                                              1000),
                                      isBoxLimited: true,
                                    ),
                                  );
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        children: List.generate(
                            assignment?.attachments?.length ?? 0, (index) {
                          return horizontalChapterItem(
                            ...
                            downloadSheet(
                                assignment!.attachments![index].url!,
                                assignment!.attachments![index].url!
                                    .split('/')
                                    .last);
                          }, iconColor: greyB2);
          ...
          AnimatedPositioned(
              ...
              child: Container(
                ...
                child: button(
                    onTap: () {
                      if (isMyAssignment) {
                        nextRoute(AssignmentHistoryPage.pageName,
                            arguments: [assignment!, false]);
                      } else {
                        nextRoute(SubmissionsPage.pageName,
                    ...
                    height: 52,
                    text: isMyAssignment
                        ? appText.viewAssignment
                        : appText.reviewSubmissions,
                    bgColor: green77(),
