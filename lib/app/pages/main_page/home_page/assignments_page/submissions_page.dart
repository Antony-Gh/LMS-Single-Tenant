...
import 'package:esoi/app/pages/main_page/home_page/assignments_page/assignment_history_page.dart';
import 'package:esoi/app/services/user_service/assignment_service.dart';
import 'package:esoi/app/widgets/main_widget/assignment_widget/submissions_widget.dart';
          ...
          Expanded(
              child: TabBarView(
                ...
                isLoadingPending
                    ? loading()
                    : pendingData.isEmpty
                        ? emptyState(AppAssets.submissionEmptyStateSvg,
                            appText.noSubmissions, appText.noSubmissionsDesc)
                        : SingleChildScrollView(
                            ...
                            child: Column(
                              children:
                                ...
                                return SubmissionsWidget.userItem(() async {
                                  await nextRoute(
                                      AssignmentHistoryPage.pageName,
                                      arguments: [pendingData[index], true]);
                                  getData();
                                }, pendingData[index]);
                              }),
                            ),
                ...
                isLoadingPending
                    ...
                    : allSubmissionData.isEmpty
                        ...
                        : SingleChildScrollView(
                            ...
                            padding: padding(vertical: 20),
                            child: Column(
                              children: List.generate(allSubmissionData.length,
                                  (index) {
                                return SubmissionsWidget.userItem(() async {
                                  await nextRoute(
                                      AssignmentHistoryPage.pageName,
