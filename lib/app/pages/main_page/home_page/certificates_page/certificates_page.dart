...
import 'package:esoi/app/models/certificate_model.dart';
import 'package:esoi/app/pages/main_page/home_page/certificates_page/certificates_details_page.dart';
import 'package:esoi/app/providers/user_provider.dart';
import 'package:esoi/app/services/user_service/certificate_service.dart';
import 'package:esoi/app/widgets/main_widget/quizzes_widget/quizzes_widget.dart';
                            ...
                            ...List.generate(completionData.length, (index) {
                              return userCard(
                                  ...
                                  parse(completionData[index]
                                      ...
                                      '',
                                  timeStampToDate(
                                      (completionData[index].createdAt ?? 0) *
                                          1000),
                                  '',
                                  '', () {
                                nextRoute(CertificatesDetailsPage.pageName,
