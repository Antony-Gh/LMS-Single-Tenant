...
import 'package:esoi/app/models/meeting_model.dart';
                ...
                Expanded(
                    child: isLoading
                        ...
                        : TabBarView(
                            ...
                            children: [
                                // reservations
                                (meetings?.reservations?.meetings?.isEmpty ??
                                        true)
                                    ? Center(
                                        child: emptyState(
                                            AppAssets.mettingEmptyStateSvg,
                                            appText.noMeetings,
                                            appText.noMeetingsDesc))
                                ...
                                if (locator<UserProvider>().profile?.roleName !=
                                    'user') ...{
                                  // requests
                                  (meetings?.requests?.meetings?.isEmpty ??
                                          true)
                                      ? Center(
                                          child: emptyState(
                                              AppAssets.mettingEmptyStateSvg,
