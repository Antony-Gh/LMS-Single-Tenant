                ...
                body: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (userProvider.profile?.academicYear?.name != null ||
                          userProvider.profile?.academicLevel?.name != null) ...[
                        Padding(
                          padding: padding(),
                          child: Container(
                            width: getSize().width,
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      space(4),
                                      Text(
                                          userProvider.profile?.academicYear
                                                  ?.name ??
                                              '-',
                                          style: style14Bold()),
                                    ],
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      space(4),
                                      Text(
                                          userProvider.profile?.academicLevel
                                                  ?.name ??
                                              '-',
                                          style: style14Bold()),
                                    ],
