...
import 'package:esoi/app/pages/main_page/home_page/single_course_page/learning_page.dart';
import 'package:esoi/app/providers/user_provider.dart';
import 'package:esoi/app/services/guest_service/course_service.dart';
import 'package:esoi/app/services/user_service/cart_service.dart';
import 'package:esoi/app/services/user_service/purchase_service.dart';
import 'package:esoi/app/widgets/main_widget/home_widget/single_course_widget/pod_video_player.dart';
import 'package:esoi/common/components.dart';
import 'package:esoi/app/widgets/main_widget/home_widget/single_course_widget/course_video_player.dart';
import 'package:esoi/app/widgets/main_widget/home_widget/single_course_widget/single_course_widget.dart';
import 'package:esoi/app/widgets/main_widget/home_widget/single_course_widget/special_offer_widget.dart';
                                                      ...
                                                      if (courseData
                                                        ...
                                                        if (isValidYoutubeUrl(
                                                          ...
                                                          PodVideoPlayerDev(
                                                            ...
                                                            ValueKey(
                                                                'video_${courseData!.id}'),
                                                          ),
                                                        } else ...{
                                                          // ❌ لينك غلط -> نعرض صورة الكورس بدل الفيديو
                                                          ClipRRect(
                                                            borderRadius:
                                                                borderRadius(),
                                                            child: Stack(
