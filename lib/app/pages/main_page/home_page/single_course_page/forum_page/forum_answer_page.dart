...
class _ForumAnswerPageState extends State<ForumAnswerPage> {
  ...
  Widget build(BuildContext context) {
    return directionality(
        child: Scaffold(
      appBar: appbar(title: questionData?.title ?? ''),
      body: isLoading
          ? loading()
          : Stack(
              children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        if (questionData != null) ...{
                          forumQuestionItem(questionData!, () {
                            setState(() {});
                          },
                              ignoreOnTap: true,
                        ...
                        ...List.generate(answers.length, (index) {
                          return forumAnswerItem(answers[index], () {
                            setState(() {});
                          }, getNewData: getData);
                        }),
                        space(120),
                ...
                AnimatedPositioned(
                    ...
                    child: Container(
                        ...
                        child: button(
                          onTap: () async {
                            bool? res = await LearningWidget.forumReplaySheet(
                                questionData!);
