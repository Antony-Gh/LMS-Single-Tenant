...
import 'package:esoi/app/models/note_model.dart';
...
class _SingleContentPageState extends State<SingleContentPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      try {
        authHasBought =
            (ModalRoute.of(context)!.settings.arguments as List)[3] ?? true;
      } catch (_) {}
  ...
  Future getNote() async {
    note = await PersonalNoteService.getNote(
        content!.id!, singleContentData!.contentType!);
                        ...
                        if (content?.type == 'text_lesson') ...{
                          ...
                          AspectRatio(
                            ...
                            child: ClipRRect(
                                ...
                                child: fadeInImage(
                                    '${Constants.dommain}${singleContentData?.image}',
                                    getSize().width,
                                    getSize().width)),
                          ),
                        },
