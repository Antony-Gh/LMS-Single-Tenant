...
import 'package:esoi/app/services/user_service/support_service.dart';
import 'package:esoi/app/widgets/main_widget/support_widget/support_widget.dart';
                    ...
                    : ticketsData.isEmpty
                        ? Center(
                            child: emptyState(AppAssets.commentsEmptyStateSvg,
                                appText.noTickets, appText.noTicketsDesc))
                        : SingleChildScrollView(
                            physics: const BouncingScrollPhysics(),
                            padding: padding(),
                            child: Column(
                              children:
                                  List.generate(ticketsData.length, (index) {
                                return item(
                ...
                isLoadingClasses
                    ...
                    : classSupportData.isEmpty
                        ...
                        : SingleChildScrollView(
                            ...
                            padding: padding(),
                            child: Column(
                              children: List.generate(classSupportData.length,
                                  (index) {
                                return item(
                                    classSupportData[index].title ?? '',
                                    timeStampToDateHour(
                                        (classSupportData[index].createdAt ??
                                                0) *
                                            1000),
                                    classSupportData[index].status ?? '', () {
                                  nextRoute(ConversationPage.pageName,
                                      arguments: classSupportData[index].id);
                                });
                              }),
                            ),
                          ),
                          ...
                          : SingleChildScrollView(
                              ...
                              child: Column(
                                children: List.generate(
                                    myClassSupportData.length, (index) {
                                  return item(
                                      myClassSupportData[index].title ?? '',
                                      timeStampToDateHour(
                                          (myClassSupportData[index]
                                                      .createdAt ??
                                                  0) *
                                              1000),
          ...
          : button(
              onTap: () async {
                if (currentTab == 0) {
                  ...
                  bool? res =
                      await SupportWidget.newSupportMessageForClassesSheet();
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: whiteFF_26, borderRadius: borderRadius(radius: 16)),
        child: Row(
          children: [
            // icon
            Container(
              ...
              height: 65,
              decoration: BoxDecoration(
                  color: green77(), borderRadius: borderRadius(radius: 14)),
              child: Center(
