...
import 'package:esoi/app/models/favorite_model.dart';
  ...
  Widget build(BuildContext context) {
    return directionality(
      ...
      body: isLoading
          ...
          : favorites.isEmpty
              ? Center(
                  child: emptyState(AppAssets.favoriteEmptyStateSvg,
                      appText.noFavorites, appText.noFavoritesDesc))
                          ...
                          child: Directionality(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                  color: red49, borderRadius: borderRadius()),
                              margin: padding(),
                              child: Slidable(
                                key: UniqueKey(),
