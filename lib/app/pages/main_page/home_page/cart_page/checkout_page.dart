...
// import 'package:esoi/app/models/checkout_model.dart';
// import 'package:esoi/app/pages/main_page/main_page.dart';
// import 'package:esoi/app/services/user_service/cart_service.dart';
// import 'package:esoi/app/widgets/main_widget/home_widget/cart_widget.dart';
...
//     checkoutData?.paymentChannels?.add(PaymentChannels(
//         id: -2,
//         image: AppAssets.accountChargeSvg,
//         type: 'charge',
//         title: appText.accountCharge));
...
//                                 padding: padding(),
//                                 itemCount:
//                                     checkoutData?.paymentChannels?.length ?? 0,
//                                 gridDelegate:
...
//                                           checkoutData?.paymentChannels?[index];
...
//                                       child: button(
//                                           onTap: () async {
//                                             if (selectedPaymentChannels?.type ==
//                                                 'charge') {
//                                               // pay with account charge
...
//                                                     ErrorEnum.success,
//                                                     appText
//                                                         .successfulPaymentDesc);
//                                               }

//                                               setState(() {
//                                                 isLoadingStartPay = false;
//                                               });
//                                             } else if (selectedPaymentChannels
//                                                     ?.type ==
//                                                 'offline') {
//                                               // offline payment

//                                               CartWidget.showOfflinePaySheet(
//                                                   checkoutData!.order!.id!);
//                                             } else if (selectedPaymentChannels
//                                                     ?.type ==
//                                                 'online') {
