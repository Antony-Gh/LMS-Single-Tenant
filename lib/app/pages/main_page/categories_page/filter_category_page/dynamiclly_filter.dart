      ...
      child: SingleChildScrollView(
        ...
        child: directionality(
          ...
          child: Column(children: [
                ...
                children: [
                  ...
                  ...List.generate(filters[index].options?.length ?? 0, (i) {
                    return Padding(
                      ...
                      child: checkButton(
                          filters[index].options?[i].title ?? '',
                          filterSelected.contains(
                              filters[index].options?[i].id), (value) {
                        if (filterSelected
                            .contains(filters[index].options?[i].id)) {
                          filterSelected.remove(filters[index].options?[i].id);
                        } else {
                          filterSelected
                              .add(filters[index].options?[i].id ?? -1);
                        }
            ...
            button(
                onTap: () {
                  locator<FilterCourseProvider>().filterSelected =
                      filterSelected;
