...
import 'package:esoi/app/pages/main_page/providers_page/user_profile_page/finalize_date_page.dart';
...
class _SelectDatePageState extends State<SelectDatePage> {
  ...
  getMeetings() async {
    ...
    meetings = await ProvidersService.getMeetings(widget.userId,
              ...
              Container(
                ...
                child: TableCalendar(
                  ...
                  calendarStyle: CalendarStyle(
                      ...
                      defaultTextStyle: style14Regular()),
                  rowHeight: 45,
                ),
              ),
