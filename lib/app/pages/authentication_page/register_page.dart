...
import 'package:esoi/app/pages/authentication_page/verify_code_page.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  List<AcademicLevelModel> academicLevels = [];
  AcademicLevelModel? selectedAcademicLevel;
  ...
  void initState() {
    super.initState();
    debugPrint('apiConfigData = ${PublicData.apiConfigData}');
  ...
  getAcademicLevels() async {
    academicLevels = await AcademicService.levels();

    if (academicLevels.isNotEmpty) {
      selectedAcademicLevel = academicLevels.first;
    }
                ...
                children: [
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<AcademicLevelModel>(
                        ...
                        items: academicLevels.map((level) {
                          return DropdownMenuItem<AcademicLevelModel>(
                            value: level,
                  ...
                  Center(
                    child: button(
                        onTap: () async {
                          if (!isEmptyInputs) {
                            if (selectedAcademicLevel?.id == null) {
