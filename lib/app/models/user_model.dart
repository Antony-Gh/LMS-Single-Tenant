class UserModel {
  ...
  UserModel.fromJson(Map<String, dynamic> json) {
    ...
    academicYear = json['academic_year'] != null
        ? AcademicInfo.fromJson(json['academic_year'])
        : null;
    academicLevel = json['academic_level'] != null
        ? AcademicInfo.fromJson(json['academic_level'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (academicLevel != null) {
      data['academic_level'] = academicLevel!.toJson();
    }
    data['bio'] = bio;
...
class AcademicInfo {
  ...
  AcademicInfo({this.id, this.name});

  AcademicInfo.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
  }
