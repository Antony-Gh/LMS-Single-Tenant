...
import 'package:esoi/app/models/forum_answer_model.dart';
...
import 'package:esoi/app/pages/main_page/home_page/cart_page/cart_page.dart';
import 'package:esoi/app/pages/main_page/home_page/single_course_page/forum_page/forum_answer_page.dart';
import 'package:esoi/app/pages/main_page/home_page/single_course_page/single_course_page.dart';
import 'package:esoi/app/providers/user_provider.dart';
import 'package:esoi/app/services/user_service/forum_service.dart';
import 'package:esoi/common/utils/constants.dart';
import 'package:esoi/common/utils/download_manager.dart';
import 'package:esoi/common/utils/role_translator.dart';
import 'package:esoi/common/utils/utils.dart';
...
Widget courseItemVertically(CourseModel courseData,
  ...
  return Container(
    ...
    decoration: BoxDecoration(color: whiteFF_26, borderRadius: borderRadius()),
    padding: padding(horizontal: 8, vertical: 8),
    width: getSize().width,
    child: GestureDetector(
      onTap: () {
      ...
      child: Row(
        children: [
          Container(
            ...
            alignment: Alignment.center,
            child: SvgPicture.network(icon, width: 24),
          ),
          space(0, width: 16),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
                ...
                AnimatedPositionedDirectional(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(color: greyCF, width: 4),
                        color: state ? green77() : greyE7,
                        boxShadow: [
    ...
    child: Row(
      ...
      children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
              shape: BoxShape.circle,
              border: Border.all(color: greyCF, width: 6),
              color: state ? green77() : greyE7,
              boxShadow: [
...
Widget userProfile(UserModel user,
  ...
  return Container(
    ...
    decoration: isBackground
        ? BoxDecoration(
            color: whiteFF_26, borderRadius: borderRadius(radius: 10))
        : null,
