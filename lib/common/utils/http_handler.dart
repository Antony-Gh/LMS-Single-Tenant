...
Future<Response> httpGet(String url,
  ...
  _printTransaction(url: url, response: res, method: 'GET');
...
Future<Response> httpPost(String url, dynamic body,
  ...
  _printTransaction(url: url, response: res, body: body, method: 'POST');
...
Future<Response> httpDelete(String url, dynamic body,
  ...
  _printTransaction(url: url, response: res, body: body, method: 'DELETE');
...
Future<Response> httpPut(String url, dynamic body,
  ...
  _printTransaction(url: url, response: res, body: body, method: 'PUT');
...
Future<dio.Response> dioPost(String url, dynamic body,
  ...
  _printTransaction(
      url: url,
      response: http.Response(res.data.toString(), res.statusCode ?? 0),
      body: body,
      method: 'POST (DIO)');
