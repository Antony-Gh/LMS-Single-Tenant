...
extension CustomDate on DateTime {
  String toDate() =>
      DateFormat('d MMM y', locator<AppLanguage>().currentLanguage)
          .format(this);

  String toHour() =>
      DateFormat('Hms', locator<AppLanguage>().currentLanguage).format(this);
